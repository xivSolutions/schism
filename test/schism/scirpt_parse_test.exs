defmodule Schism.SqlPaserTest do
  ...
  # test "groups view alter statements into list", %{script: dump_file_content} do
  #   res = dump_file_content
  #   |> strip_comments_and_whitespace

  #   list = get_alter_view_statements res
  #   first = Enum.at(list, 0)
  #   assert Enum.count(list) > 0 && String.starts_with?(first, "ALTER VIEW") 
  # end
